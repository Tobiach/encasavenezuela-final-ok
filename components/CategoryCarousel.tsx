      ...
      >
        <div className="flex gap-3 md:gap-10 px-4 md:px-6 py-4 md:py-8 md:animate-marquee">
          {doubleCategories.map((cat, idx) => (
            ...
            >
              <div className="relative aspect-[1/1] md:aspect-[4/5] rounded-[20px] md:rounded-[48px] overflow-hidden border border-black/10 shadow-[0_20px_40px_-12px_rgba(0,0,0,0.1)] md:shadow-[0_30px_60px_-15px_rgba(0,0,0,0.1)] mb-3 md:mb-6 group-hover:border-ven-yellow/40 transition-all duration-700 group-hover:-translate-y-3 group-hover:shadow-[0_40px_80px_-20px_rgba(255,204,0,0.2)]">
                <img 
                  src={cat.image} 
                  alt={cat.name} 
