  ...
  return (
    <section className="bg-white px-4 pt-8 pb-6">
      ...
      <div className="flex justify-center mb-5">
        <span className="bg-ven-yellow/15 text-ven-yellow font-bold text-xs rounded-full px-3 py-1 border border-ven-yellow/30">
      ...
      <div className="flex justify-center items-center gap-2 text-xs text-gray-500 mb-6 flex-wrap">
        ...
        <span className="bg-ven-yellow/15 text-ven-yellow rounded-full px-3 py-1 font-semibold">40+ productos</span>
        <span className="text-gray-300">·</span>
      ...
      <div className="max-w-sm mx-auto space-y-3">
        <button
          ...
          className="w-full bg-ven-yellow text-black font-black rounded-2xl py-3.5 flex items-center justify-center gap-2 active:scale-[0.98] transition-all shadow-md shadow-yellow-400/20 hover:brightness-95"
        >
          <ShoppingBag size={18} />
          Explorar locales →
        </button>
